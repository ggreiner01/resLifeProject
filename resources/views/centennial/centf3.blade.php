...
<html lang="en">
  <head>
    ...
    <title>Centennial Third Floor</title>
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Centennial Hall third floor</h1>
          </div>

          <p style="text-align:center;"><img src="/pictures/Centennial_Hall_Third_Floor.jpg"  alt="Card image cap" height="500" width ="380" style = "transform:rotate(270deg)"></p>
